...
奥德赛负责打开可能性，三年战略负责承接当前选择。两者不能合并为同一份“最优路径评分表”。
...
| 方向不确定或人生转折 | Odyssey | 通常串行访谈；外部研究可只读并行 |
| 已有方向但缺少真实证据 | Prototype | 否；逐个原型获取反馈 |
...
- **Odyssey**：现实与自我观察 → 问题重构 → 三个五年版本 → 跨计划信号与未知 → 原型队列。
- **Prototype**：学习问题 → 原型对话或体验 → 支持／反对证据 → 本人选择或迭代 → 三年战略。
